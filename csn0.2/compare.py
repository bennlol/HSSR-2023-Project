...
siamese.load_weights(os.path.join("csn0.2","train on 1 and 0","model.h5"))
...
results = siamese.predict(load_pair("V4-T8-31step10s.png", cluster_dirs[2], "V1-T1-6step5s.png",cluster_dirs[5]))
print(f"(single void defect) : (), prediction: ${results}")
